...
# ---------------------------------------------------------------------------
#
# Cada tupla: (bloco, nome, padrão_1est, padrão_2est, esp_1est, esp_2est, fechada)
#
...
PAVIMENTOS: tuple[tuple, ...] = (
    ("Bloco D", "3º Pavimento",            9,  0,  0, 0,  0),
    ("Bloco E", "1º Pavimento (Térreo)",   0,  0,  0, 0, 35),
    ("Bloco E", "2º Pavimento",           35,  8, 11, 3,  0),
    ("Bloco E", "3º Pavimento",           27,  0,  0, 0,  0),
    ("Bloco F", "2º Pavimento",            8, 13,  0, 0,  0),
    ("Bloco F", "3º Pavimento",           15,  0,  0, 0,  0),
    ("Bloco F", "4º Pavimento",           26,  0,  0, 0,  0),
    ("Bloco F", "5º Pavimento",           22,  0,  0, 0,  0),
    ("Bloco F", "6º Pavimento",            0,  0, 15, 0,  0),
    ("Bloco Anexo", "1º Pavimento (Térreo)", 11, 2, 0, 0,  0),
)
...
def capacidade_total() -> int:
    ...
    return sum(
        ...
        for _, _, p1, p2, e1, e2, _ in PAVIMENTOS
    )
